...
credit_card <- read.csv("~/Documents/creditcard.csv")
...
#set the number of fraud and legit cases, and desired % of legit cases
n0 <- 22750
n1 <- 35
r0 <- 0.6
...
confusionMartix(predicted_val , credit_card$Class)
